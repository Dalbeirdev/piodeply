    ...
    <div class="container prose">
        ...
        @php
            ...
            $faqs = [
                ...
                ['Which package sources are supported?', 'The full <a href="https://learn.microsoft.com/windows/package-manager/winget/" target="_blank" rel="noopener noreferrer" class="tlink ext">winget</a> catalogue and <a href="https://chocolatey.org/" target="_blank" rel="noopener noreferrer" class="tlink ext">Chocolatey</a>, plus MSI, EXE, MSIX, ZIP and custom PowerShell. See the <a href="'.route('features').'" class="tlink">full feature list</a>.'],
