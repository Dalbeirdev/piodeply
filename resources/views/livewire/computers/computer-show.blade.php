    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                ...
                @else
                    <span class="ml-2 align-middle inline-flex items-center gap-1.5 text-xs font-semibold rounded-full px-2 py-0.5 border bg-gray-100 text-gray-600 border-gray-200">
            ...
            @can('update', $computer)
                <a href="{{ route('computers.edit', $computer) }}"
                   class="text-sm font-semibold text-indigo-600 hover:underline">Reassign project</a>
            @endcan
        </div>
    </x-slot>
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            @foreach ($sections as $title => $rows)
                <div class="bg-white shadow-xl sm:rounded-lg p-6">
                    <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">{{ $title }}</h3>
                    <dl class="space-y-2">
            ...
            <div class="bg-white shadow-xl sm:rounded-lg p-6">
                <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3">Security posture</h3>
                <dl class="space-y-2">
                    <div class="flex justify-between gap-4 text-sm">
                        <dt class="text-gray-500">Secure Boot</dt>
                        <dd>
                            @if ($computer->secure_boot === null) <span class="text-gray-400">unknown</span>
                    ...
                    <div class="flex justify-between gap-4 text-sm">
                        <dt class="text-gray-500">TPM</dt>
                        <dd>
                            @if ($computer->tpm_enabled === null) <span class="text-gray-400">unknown</span>
