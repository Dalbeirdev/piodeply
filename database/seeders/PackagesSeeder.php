    ...
    public function run(): void
    {
        $catalog = [
            ...
            'Media' => [
                ...
                ['OBS Studio', 'OBS Project', 'OBSProject.OBSStudio', 'GPL-2.0', true],
                ['Kodi', 'XBMC Foundation', 'XBMCFoundation.Kodi', 'GPL-2.0', true],
                ['Plex', 'Plex', 'Plex.Plex', 'Freemium', true],
                ['MPC-HC', 'clsid2', 'clsid2.mpc-hc', 'GPL-3.0', false],
            ],
            '.NET' => [
                ...
                ['.NET SDK 8', 'Microsoft', 'Microsoft.DotNet.SDK.8', 'MIT', true],
                ['.NET SDK 9', 'Microsoft', 'Microsoft.DotNet.SDK.9', 'MIT', true],
            ],
            'Java' => [
            ...
            'Documents' => [
                ...
                ['ONLYOFFICE Desktop Editors', 'ONLYOFFICE', 'ONLYOFFICE.DesktopEditors', 'AGPL-3.0', true],
                ['Obsidian', 'Obsidian', 'Obsidian.Obsidian', 'Freemium', true],
                ['Joplin', 'Joplin', 'Joplin.Joplin', 'MIT', true],
                ['PDF24 Creator', 'geek software GmbH', 'geeksoftwareGmbH.PDF24Creator', 'Freeware', true],
                ['WPS Office', 'Kingsoft', 'Kingsoft.WPSOffice', 'Freemium', false],
            ],
            'Security' => [
                ...
                ['KeePassXC', 'KeePassXC Team', 'KeePassXCTeam.KeePassXC', 'GPL-3.0', true],
                ['1Password', 'AgileBits', 'AgileBits.1Password', 'Commercial', true],
                ['Proton VPN', 'Proton', 'Proton.ProtonVPN', 'GPL-3.0', true],
                ['Cloudflare WARP', 'Cloudflare', 'Cloudflare.Warp', 'Freeware', true],
                ['Tailscale', 'Tailscale', 'tailscale.tailscale', 'BSD-3-Clause', true],
                ['WireGuard', 'WireGuard', 'WireGuard.WireGuard', 'GPL-2.0', true],
            ],
            'File Sharing' => [
            ...
            'Utilities' => [
                ...
                ['Rufus', 'Pete Batard', 'Rufus.Rufus', 'GPL-3.0', true],
                ['balenaEtcher', 'balena', 'Balena.Etcher', 'Apache-2.0', true],
                ['AutoHotkey', 'AutoHotkey Foundation', 'AutoHotkey.AutoHotkey', 'GPL-2.0', true],
                ['Flameshot', 'Flameshot', 'Flameshot.Flameshot', 'GPL-3.0', true],
            ],
            'Compression' => [
                ...
                ['NanaZip', 'M2Team', 'M2Team.NanaZip', 'MIT', true],
            ],
            'VC++ Redistributables' => [
            ...
            'Developer Tools' => [
                ...
                ['Node.js LTS', 'OpenJS Foundation', 'OpenJS.NodeJS.LTS', 'MIT', true],
                ['Docker Desktop', 'Docker', 'Docker.DockerDesktop', 'Freemium', true],
                ['GitHub CLI', 'GitHub', 'GitHub.cli', 'MIT', true],
                ['GitHub Desktop', 'GitHub', 'GitHub.GitHubDesktop', 'MIT', true],
                ['Postman', 'Postman', 'Postman.Postman', 'Freemium', true],
                ['PowerShell 7', 'Microsoft', 'Microsoft.PowerShell', 'MIT', true],
                ['Sublime Text 4', 'Sublime HQ', 'SublimeHQ.SublimeText.4', 'Trialware', true],
                ['Go', 'Google', 'GoLang.Go', 'BSD-3-Clause', true],
                ['Rustup', 'Rust', 'Rustlang.Rustup', 'MIT', true],
                ['Terraform', 'HashiCorp', 'Hashicorp.Terraform', 'MPL-2.0', true],
                ['kubectl', 'Kubernetes', 'Kubernetes.kubectl', 'Apache-2.0', true],
                ['Visual Studio 2022 Community', 'Microsoft', 'Microsoft.VisualStudio.2022.Community', 'Freeware', false],
                ['JetBrains Toolbox', 'JetBrains', 'JetBrains.Toolbox', 'Freeware', true],
                ['Yarn', 'Yarn', 'Yarn.Yarn', 'BSD-2-Clause', true],
            ],
            'Remote Access' => [
                ['RustDesk', 'RustDesk', 'RustDesk.RustDesk', 'AGPL-3.0', true],
                ['mRemoteNG', 'mRemoteNG', 'mRemoteNG.mRemoteNG', 'GPL-2.0', true],
            ],
            'System Tools' => [
                ['CPU-Z', 'CPUID', 'CPUID.CPU-Z', 'Freeware', true],
                ['HWMonitor', 'CPUID', 'CPUID.HWMonitor', 'Freeware', true],
                ['GPU-Z', 'TechPowerUp', 'TechPowerUp.GPU-Z', 'Freeware', true],
